      ...
      jboard.each(function(c, type, mark) {
        ...
        switch(type) {
          ...
          case C.DIM_SELECTED:
            ...
            //ctx.beginPath();
            this.ctx.fillRect(ox - this.opt.grid.x / 4, oy - this.opt.grid.x/ 4,
              this.opt.grid.x/2, this.opt.grid.x/2);
            break;
          case C.DIM_CHOICE:
            this.ctx.globalAlpha=0.5
            ...
            this.ctx.fillRect(ox - this.opt.grid.x / 4, oy - this.opt.grid.x/ 4,
              this.opt.grid.x/2, this.opt.grid.x/2);
            break;
          case C.BLACK_TERRITORY:
            this.ctx.globalAlpha=0.5
            this.ctx.fillStyle = '#000';
            //ctx.beginPath();
            this.ctx.fillRect(ox - this.opt.grid.x / 6, oy - this.opt.grid.x/ 6,
              this.opt.grid.x/3, this.opt.grid.x/3);
            break;
          case C.WHITE_TERRITORY:
            this.ctx.globalAlpha=0.5
...
// Alias all objects into globals
    ...
    Stones.prototype.drawMark = function(ctx, mark, ox, oy) {
      switch(mark) {
        ...
        case C.MARK.SELECTED:
          ...
          //ctx.beginPath();
          ctx.fillRect(ox - this.gridX / 4, oy - this.gridY / 4,
    ...
    'use strict';
    window.JGO = require('./JGO'); // expose as global object
